...
import 'package:flutter_application_2/view/taskaddedscreen/task_addedscreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colorconstaints.blue,
        leading: Builder(
          builder: (context) {
            return IconButton(
                onPressed: () {
        ...
        title: Text(
          "All Lists",
          style: TextStyle(color: Colorconstaints.white, fontWeight: FontWeight.bold),
        ),
        actions: [
          Icon(
